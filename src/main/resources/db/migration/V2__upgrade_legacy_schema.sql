-- Incremental migration for databases created before payment/session/logging features.
-- Existing databases should baseline at version 1, then apply this migration.
